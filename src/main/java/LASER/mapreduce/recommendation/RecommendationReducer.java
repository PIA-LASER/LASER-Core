...
public class RecommendationReducer extends Reducer<VarIntWritable, PrefAndSimilarityColumnWritable, VarLongWritable, RecommendedItemsWritable> {
    ...
    public void reduce(VarIntWritable userId, Iterable<PrefAndSimilarityColumnWritable> values, Context context)
        ...
        while(itemsIter.hasNext()) {
            ...
            System.out.println("Item " + index + ": " + (numerators.get(index) / denominators.get(index)));
        }
    }
}
